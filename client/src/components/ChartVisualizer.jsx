...
export default function ChartVisualizer({ data = [], defaultXKey = 'Name', defaultYKey = 'Salary' }) {
  ...
  const isReady = data.length > 0 && xKey && yKey && keys.includes(xKey) && keys.includes(yKey);
  ...
  return (
    <div style={{ marginTop: '2rem', textAlign: 'center' }}>
      ...
      <div ref={chartRef} style={{ width: chartWidth, height: 400, margin: '0 auto' }}>
        {chartType === 'Bar' && (
