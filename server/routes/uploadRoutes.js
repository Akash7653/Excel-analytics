/* This JavaScript code snippet is setting up a backend API using Express.js to handle Excel file
uploads and processing. Here is a breakdown of what the code is doing: */
  ...
  async (req, res) => {
    try {
      ...
      res.json({ 
        success: true,
        data,
        message: req.user.role === 'admin' ? 'Admin upload successful' : 'Upload successful'
      });
